            ...
            switch (mensaje) {
                case "1":
                    ...
                    switch (meta.getCategoria()) {
                        case "Salud":
                            cabecera.setBackgroundColor(getResources().getColor(R.color.abc_primary_text_material_dark));
                            break;
                        case "Finanzas":
                            cabecera.setBackgroundColor(getResources().getColor(R.color.abc_input_method_navigation_guard));
                            break;
                        case "Espiritual":
                            cabecera.setBackgroundColor(getResources().getColor(R.color.abc_primary_text_material_dark));
                            break;
                        case "Profesional":
                            ...
                            break;
                        case "Material":
                            cabecera.setBackgroundColor(getResources().getColor(R.color.switch_thumb_material_light));
                            break;
                    }
